...
$.ajax({
  ...
  success: function (data) {
    document.getElementsByTagName("meta")[3]["content"] = data.result[0].slug;
    document.getElementsByTagName("meta")[5]["content"] = data.result[0].judul;
    document.getElementsByTagName("meta")[6]["content"] = data.result[0].deskripsi;

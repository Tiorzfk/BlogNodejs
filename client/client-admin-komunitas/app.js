...
(function($) {
  ...
  var email=sessionStorage.getItem("email"),
      ...
      komunitas=sessionStorage.getItem("komunitas");
  $('#email').text(email);
  $('#jenis').text(jenis);
  $('#kom').text(komunitas);
  var app = $.sammy('#app', function() {
    ...
    this.get('#/', function(context) {
      $('#namepage').text('Dashboard '+komunitas);
    ...
    this.get('#/posting/', function(context) {
        $('#breadcrumb').text('Manage Posting');
        $('#namepage').text('Manage Posting');
        var str=location.href.toLowerCase();
        context.app.swap('');
        context.render('posting/index.template')
               .appendTo(context.$element());
    });
